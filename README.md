## Project: SmartDocs or *any creative name you like*
...
* **Contextual Intelligence:** The AI must generate answers based on the provided document(s) library.
...
* **Data Structures:** Implement a strategy for **text segmentation** (splitting large documents into manageable units) and metadata.
* **Search Algorithm:** Implement an algorithm to find the most relevant sections of text for a given query
